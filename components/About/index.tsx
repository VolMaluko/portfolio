...
import { Code2, Rocket, Briefcase, Brain } from "lucide-react";
import { ImageWithFallback } from "../figma/ImageWithFallback";

export function About() {
	const stats = [
		{ icon: Code2, label: "Projetos Concluídos", value: "15+" },
		{ icon: Rocket, label: "Tempo de experiência", value: "+ de 1 ano" },
		{ icon: Briefcase, label: "Tempo de trabalho real", value: "+ de 1 ano" },
		{ icon: Brain, label: "Vontade de aprendizado", value: "∞" },
	];
			...
			<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
				...
				<div className='grid lg:grid-cols-2 gap-12 items-center mb-20'>
					<motion.div
						...
						transition={{ duration: 0.6 }}
						className='relative'>
						<div className='absolute inset-0 bg-linear-to-br from-cyan-500/20 to-blue-500/20 rounded-2xl blur-2xl' />
				...
				<div className='grid grid-cols-2 lg:grid-cols-4 gap-6'>
					{stats.map((stat, index) => (
						<motion.div
							...
							<div className='absolute inset-0 bg-linear-to-br from-cyan-500/10 to-blue-500/10 rounded-xl blur-xl group-hover:blur-2xl transition-all' />
							<div className='relative p-6 bg-slate-900/50 border border-cyan-500/20 rounded-xl text-center hover:border-cyan-500/50 transition-colors'>
								...
								<div className='mb-2 bg-linear-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent'>
									{stat.value}
								</div>
