      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <motion.div
            ...
            className="inline-block mb-6 px-4 py-2 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-full"
          >
          ...
          >
            ...
            Criando experiências web incríveis com código limpo.
          </motion.p>
          ...
          >
            {[
              ...
              { icon: Linkedin, href: "https://www.linkedin.com/in/volnei-danielli" },
