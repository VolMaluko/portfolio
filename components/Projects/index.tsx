  ...
  const projects = [
    {
      ...
      description: "Plataforma completa de e-commerce com Next.js, integração de pagamento e painel administrativo.",
    ...
    },
    {
      ...
      description: "Dashboard interativo para análise de dados em tempo real com gráficos e métricas avançadas.",
    ...
    },
    {
      ...
      description: "Aplicativo de rede social com feed em tempo real, chat e notificações push.",
    ...
    },
    {
      ...
      description: "Ferramenta de geração de conteúdo utilizando IA para criar textos e imagens automaticamente.",
    ...
    },
    {
      ...
      description: "Sistema completo de gerenciamento de tarefas com Kanban board e colaboração em equipe.",
    ...
    },
    {
      ...
      description: "Plataforma para criação de portfólios profissionais com templates customizáveis.",
              ...
              <div className="relative bg-slate-900/50 border border-cyan-500/20 rounded-2xl overflow-hidden hover:border-cyan-500/50 transition-all">
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button
                      size="sm"
                      className="flex-1 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 border-0"
                    >
